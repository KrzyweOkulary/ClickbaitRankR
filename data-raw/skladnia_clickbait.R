#' Domyślna składnia modelu clickbaitu
#'
#' @description
#' Definiuje strukturę kryteriów oraz przypisanych do nich wskaźników 
#' wykorzystywaną do oceny poziomu dezinformacji w portalach informacyjnych.
#'
#' @return Ciąg znaków (string) w formacie strukturalnym MCDA.
#' @export
